...
Seq alerting application for Microsoft Teams with AdaptiveCard support. Based on [Seq.App.Teams](https://github.com/AntoineGa/Seq.App.Teams) application. <img src="assets/seqteams-github-460.png" alt="Seq.App.Teams.AdaptiveCard icon" width="128" align="right" />
